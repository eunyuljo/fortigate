...
module "vpc1" {
  ...
  intra_subnet_names      =  ["eyjo-parnas-vpc1-intra-1","eyjo-parnas-vpc1-intra-2","eyjo-parnas-vpc1-intra-3","eyjo-parnas-vpc1-intra-4"]
...
module "vpc2" {
  ...
  public_subnet_names     = ["eyjo-parnas-vpc2-public-101","eyjo-parnas-vpc2-public-102","eyjo-parnas-vpc2-public-103","eyjo-parnas-vpc2-public-104"]
  map_public_ip_on_launch = true
  private_subnets         = ["10.1.1.0/24", "10.1.2.0/24", "10.1.3.0/24", "10.1.4.0/24"]
  private_subnet_names    = ["eyjo-parnas-vpc2-private-1","eyjo-parnas-vpc2-private-2","eyjo-parnas-vpc2-private-3","eyjo-parnas-vpc2-private-4"]
  # tgw 용 
  intra_subnets           =  ["10.1.10.0/24","10.1.11.0/24","10.1.12.0/24","10.1.13.0/24"]
  intra_subnet_names      = ["eyjo-parnas-vpc2-intra-1","eyjo-parnas-vpc2-intra-2","eyjo-parnas-vpc2-intra-3","eyjo-parnas-vpc2-intra-4"]
  #각 VPC 환경은 NAT를 사용하지 않고 FW 을 통해 경유하도록 구성한다.
  #enable_nat_gateway       = true
  #single_nat_gateway       = true
